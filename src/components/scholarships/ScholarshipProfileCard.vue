    ...
    <template v-if="!editing">
      <div v-if="profile" class="d-flex align-center flex-wrap ga-4 mb-4">
        ...
        <template v-if="profile.active_discount_percentage">
          ...
          <div v-if="profile.discount_valid_until">
            <div class="text-caption text-medium-emphasis">Vigente hasta</div>
            <div class="text-body-2">{{ profile.discount_valid_until }}</div>
          </div>
        </template>
        <v-spacer />
